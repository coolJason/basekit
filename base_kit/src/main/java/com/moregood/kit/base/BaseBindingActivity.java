 ...
 * Descripe:
 */
public abstract class BaseBindingActivity<VM extends BaseViewModel,Binding extends ViewDataBinding> extends AppCompatActivity {
...
//        ViewGroup view = binding.getRoot().getRootView().findViewById(android.R.id.content);
//        toolBarView = LayoutInflater.from(this).inflate(R.layout.activity_toolbar,null);
//        view.addView(toolBarView);
