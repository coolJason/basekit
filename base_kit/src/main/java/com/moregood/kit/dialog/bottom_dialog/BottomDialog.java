...
public class BottomDialog {
    ...
    private final class CustomDialog extends Dialog {
        ...
        private void init() {
            ...
            topPadding = getContext().getResources().getDimensionPixelSize(R.dimen.dp_10);
            leftPadding = getContext().getResources().getDimensionPixelSize(R.dimen.dp_10);
            topIcon = getContext().getResources().getDimensionPixelSize(R.dimen.dp_10);
            leftIcon = getContext().getResources().getDimensionPixelSize(R.dimen.dp_10);
        ...
        private class DialogAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
                ...
                if (layout == GRID) {
                    ...
                    leftHolder.item.setCompoundDrawablesWithIntrinsicBounds(item.getIcon(), null, null, null);
            ...
            class TopHolder extends RecyclerView.ViewHolder {
                ...
                TopHolder(View view) {
                    ...
                    ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                    params.width = DensityUtil.getScreenWidth(getContext()) / 5;
                    ...
                    item.setTextColor(ContextCompat.getColor(view.getContext(), android.R.color.darker_gray));
                    item.setTextSize(TypedValue.COMPLEX_UNIT_SP, getContext().getResources().getDimension(R.dimen.sp_18));
            ...
            class LeftHolder extends RecyclerView.ViewHolder {
                ...
                LeftHolder(View view) {
                    ...
                    item.setTextColor(ContextCompat.getColor(view.getContext(), android.R.color.black));
                    item.setTextSize(TypedValue.COMPLEX_UNIT_SP, getContext().getResources().getDimension(R.dimen.sp_18));
