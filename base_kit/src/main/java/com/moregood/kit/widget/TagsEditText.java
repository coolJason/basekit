...
public class TagsEditText extends AppCompatAutoCompleteTextView {
    ...
    public void setTagsTextSize(@DimenRes int textSize) {
        mTagsTextSize = ResourceUtil.getDimension(getContext(), textSize);
        setTags(convertTagSpanToArray(mTagSpans));
    }
    ...
    public void setCloseDrawablePadding(@DimenRes int padding) {
        mDrawablePadding = ResourceUtil.getDimensionPixelSize(getContext(), padding);
        setTags(convertTagSpanToArray(mTagSpans));
    }
    ...
    private void init(@Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs == null) {
            ...
            mTagsTextSize = ResourceUtil.getDimensionPixelSize(context, R.dimen.defaultTagsTextSize);
            ...
            mDrawablePadding = ResourceUtil.getDimensionPixelSize(context, R.dimen.defaultTagsCloseImagePadding);
            mTagsPaddingRight = ResourceUtil.getDimensionPixelSize(context, R.dimen.defaultTagsPadding);
            mTagsPaddingLeft = ResourceUtil.getDimensionPixelSize(context, R.dimen.defaultTagsPadding);
            mTagsPaddingTop = ResourceUtil.getDimensionPixelSize(context, R.dimen.defaultTagsPadding);
            mTagsPaddingBottom = ResourceUtil.getDimensionPixelSize(context, R.dimen.defaultTagsPadding);
        } else {
            ...
            try {
                ...
                mTagsTextSize = typedArray.getDimensionPixelSize(R.styleable.TagsEditText_tagsTextSize,
                        ResourceUtil.getDimensionPixelSize(context, R.dimen.defaultTagsTextSize));
                ...
                mDrawablePadding = typedArray.getDimensionPixelOffset(R.styleable.TagsEditText_tagsCloseImagePadding,
                        ResourceUtil.getDimensionPixelSize(context, R.dimen.defaultTagsCloseImagePadding));
                mTagsPaddingRight = typedArray.getDimensionPixelSize(R.styleable.TagsEditText_tagsPaddingRight,
                        ResourceUtil.getDimensionPixelSize(context, R.dimen.defaultTagsPadding));
    ...
    private void removeTagSpan(Editable editable, TagSpan span, boolean includeSpace) {
        ...
        mListener.onTagsChanged(convertTagSpanToList(mTagSpans));
        mListener.onTagsRemove(tag.getSource());
    }
    ...
    public interface TagsEditListener {
        ...
        default void onTagsAdd() {

        }

        default void onTagsRemove(String s) {
