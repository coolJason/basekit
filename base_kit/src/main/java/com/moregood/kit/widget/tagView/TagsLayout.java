...
public class TagsLayout extends ViewGroup {
    ...
    public TagsLayout.tabOnclickaListener getTabOnclickaListener() {
        return tabOnclickaListener;
    }

    public void setTabOnclickaListener(TagsLayout.tabOnclickaListener tabOnclickaListener) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            child.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if(tabOnclickaListener!=null){
                        tabOnclickaListener.tabOnclick(finalI);
                    }
                }
            });
            // 测量每一个child的宽和高
