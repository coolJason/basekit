...
/**
 * @类名 AppBarLayoutBehavior
 * @描述
 * @作者 xifengye
 * @创建时间 2021/5/30 14:12
...
public class AppBarLayoutBehavior extends AppBarLayout.Behavior {
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout parent, AppBarLayout child, MotionEvent ev) {
        Logger.d(TAG, "onInterceptTouchEvent:" + child.getTotalScrollRange());
...
//            e.printStackTrace();
    ...
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout,
        ...
        Logger.d(TAG, "onNestedPreScroll:" + child.getTotalScrollRange()
    ...
    public void onNestedScroll(CoordinatorLayout coordinatorLayout, AppBarLayout child,
        ...
        Logger.d(TAG, "onNestedScroll: target:" + target.getClass() + " ,"
