...
public class EditTextUtils {
    ...
    public static SpannableStringBuilder highLightKeyword(Context context, String str, String keyword) {
        ...
        builder.setSpan(new ForegroundColorSpan(ContextCompat.getColor(context, Color.RED)), str.indexOf(keyword), str.indexOf(keyword) + keyword.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        return builder;
    }
