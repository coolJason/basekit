...
public class Compat {
    private static final String TAG = "MGCompat";
    ...
    private static Intent getCameraIntent(Context context, File cameraFile) {
        ...
        intent.putExtra(MediaStore.EXTRA_OUTPUT, Compat.getUriForFile(context, cameraFile));
        return intent;
    }
    ...
    private static Intent getVideoIntent(Context context, File videoFile) {
        ...
        intent.putExtra(MediaStore.EXTRA_OUTPUT, Compat.getUriForFile(context, videoFile));
        return intent;
    }
    ...
    public static void openFile(Context context, Uri uri, String filename, String mimeType) {
        ...
        Log.d(TAG, "openFile uri = "+ (uri != null ? uri.toString() : "uri is null"));
    ...
    public static void deleteFile(Context context, Uri uri) {
        FileUtils.deleteFile(context, uri);
    }
    ...
    public static String getFileNameByUri(Context context, Uri fileUri) {
        return FileUtils.getFileNameByUri(context, fileUri);
    }
